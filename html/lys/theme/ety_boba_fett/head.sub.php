...
<!-- yeosnoo css -->
<link href="<?php echo G5_THEME_URL?>/lys/lys.css" rel="stylesheet">


</head>

<!-- 클래스삽입 -->
<body class="<?php echo $bo_table;?>
            <?php if(defined('_INDEXX_')) echo 'mainpage'; else echo 'subpage';?>
">
<?php
